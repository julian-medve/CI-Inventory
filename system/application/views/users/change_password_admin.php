...
$(function()
{
	...
	*/
	...
	{ 
		$.ajax({
  		type: "POST",
  		url: "<?php echo site_url("admin/login/checkOldPassword")?>",
...
<form id="changepassword" class="form" name="changepassword" method="post" action="<?php echo site_url('admin/login/changepassword') ?>">
